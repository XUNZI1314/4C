...
def test_snapshot_extra_preserves_nested_detection_payloads():
    ...
    assert any("Benchmark source-audit decision dataset impact cases: 6 rows / blockers 2 / review 1 / mismatch 1 / checklist available" in line for line in summary_lines)

...
- 页面中展示 Top-1 / Top-3 coverage、case-level hit rate、dataset mean coverage、best hit rank，以及 no-p2rank / no-literature / no-evidence-route / no-conservation-rerank 在整体、case、dataset 和 residue 层面的 coverage loss，并把 P0/P1 remediation actions 导出。

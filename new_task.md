...
- [x] 单元测试和全量测试覆盖，最近一次验证：`221 passed`。
...
- 已落地 benchmark reference candidate/import summary，可把已加载的 UniProt / M-CSA / 文献 / AI 残基证据转换成待复核的 benchmark reference candidate，并明确提示不能直接当作独立精度证明。

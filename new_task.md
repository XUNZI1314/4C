...
- [x] 单元测试和全量测试覆盖，最近一次验证：`216 passed`。
...
- 已落地 benchmark dataset interpretation queue/checklist，把非 claim-ready case 拆成 P0 blocker / P2 review 队列和人工勾选清单，方便优先修复阻断 dataset-level claim 的 case。

...
- [x] 单元测试和全量测试覆盖，最近一次验证：`219 passed`。
...
- 已落地 benchmark case interpretation matrix/summary，把每个 benchmark_id 横向展开 Top-1 / Top-3 / Top-5 的 claim status、coverage、best rank 和 best pocket，并汇总 Top-1/Top-3/Top-5 最早可声明 case 数，方便快速定位 case 级瓶颈。
